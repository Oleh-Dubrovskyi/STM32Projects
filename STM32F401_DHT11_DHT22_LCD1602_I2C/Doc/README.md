# Using DHT11 and DHT22 sensors with STM32F4xx boards  
...
- to connect DHT22 humidity and temperature sensor to the STM32F4xx board;  
...
Current project (***STM32F401_DHT11_DHT22_LCD1602_I2C***) demonstrates the way to connect the ***DHT11*** and ***DHT22*** temperature and humidity sensors to the ***STM32F4xx*** boards.  

The project supposes connection of the ***LCD1602*** display via an I2C expander based on the ***IC PCF8574T***.  
...
- ***Dht library***. This library includes all needed API functions to communicate with [***DHT11 sencor***](https://www.mouser.com/datasheet/2/758/DHT11-Technical-Data-Sheet-Translated-Version-1143054.pdf) and with [***DHT22 sensor***](https://cdn.sparkfun.com/assets/f/7/d/9/c/DHT22.pdf) to get current values of humidity and temperature. This library is an extension of the ***DHT11 library*** that was described and demonstrated in the STM32 Project [***STM32F401_DHT11_LCD1602_parallel***](https://github.com/Oleh-Dubrovskyi/STM32Projects/tree/master/STM32F401_DHT11_LCD1602_parallel).
- ***DelayMicro library***. This library intended to perform microsecond and millisecond delays that are needed to support the DTH sensors' communication protocol. This library was described and demonstrated in the STM32 Project [***STM32F401_DHT11_LCD1602_parallel***](https://github.com/Oleh-Dubrovskyi/STM32Projects/tree/master/STM32F401_DHT11_LCD1602_parallel) too.

The application communicates with DHT11 and DHT22 sensors and shows current temperature and humidity on the LCD1602 Display.  
...
2. To clone a project from GitHub and import it into your STM32CubeIDE workspace, follow these steps:
    ...
    - Import STM32 Project ***STM32F401_DHT11_DHT22_LCD1602_I2C*** into your STM32CubeIDE workspace
        ...
        - Select root directory: Click *Browse...* and navigate to the root directory of the STM32 project ***STM32F401_DHT11_DHT22_LCD1602_I2C*** on your file system.  
          ...
          Select the project ***STM32F401_DHT11_DHT22_LCD1602_I2C*** to import it into your workspace.
        ...
        - Click *Finish* to complete the import process.  
          The project ***STM32F401_DHT11_DHT22_LCD1602_I2C*** will now appear in your STM32CubeIDE Project Explorer.
...
The project ***STM32F401_DHT11_DHT22_LCD1602_I2C*** requires such hardware elements:
...
5. Connect the ***DHT11*** "+" (the left pin) to the NUCLEO-F401RE +5V (pin CN6-5) and to the left contact of the First Resistor 10 kOM.
6. Connect the ***DHT11*** "-" (the right pin) to the NUCLEO-F401RE GND (pin CN6-6).
7. Connect the ***DHT11*** "Out" (the middle pin) to the NUCLEO-F401RE A0 (PA0, CN8-1) and to the right contact of the First Resistor 10 kOM.
8. Connect the first pin of the ***DHT22*** (the left pin) to the NUCLEO-F401RE +5V (pin CN6-5) and to the left contact of the Second Resistor 10 kOM.
9. Connect the fourth pin of the ***DHT22*** (the right pin) to the NUCLEO-F401RE GND (pin CN6-6).
10. Connect the second pin of the ***DHT22*** (next after the left pin) to the NUCLEO-F401RE A1 (PA1, CN8-2) and to the right contact of the Second Resistor 10 kOM.
11. The third pin of the  ***DHT22*** should not be used.

Please, take a look at the connection diagram:

![LCD1602-I2C-F401RE-DHT11-DHT22 connection diagram](./STM32F401RE_LCD1602_I2C_DHT11_DHT22_connections.jpg)  

The connections between NUCLEO-F401RE, LCD1602, DHT11 and DHT22 can look like below:  

![connections between NUCLEO-F401RE, LCD1602 DHT11 and DHT22](./DH11_DHT22_STM32F401RE_connections.jpg)  

<a id="gpio_configuration_id"></a>
### GPIO configuration

Please, take a look at the ***STM32F401_DHT11_DHT22_LCD1602_I2C.ioc*** and analyze GPIO configuration:
...
4. [You can take a look at the results by clicking here. It will take 1 minute. Thank you.](./STM32F401_DHT11_DHT22_LCD1602_I2C.mp4)
...
7. [***DHT22 Humidity & Temperature Sensor***](https://cdn.sparkfun.com/assets/f/7/d/9/c/DHT22.pdf)
